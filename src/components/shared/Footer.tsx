...
const Footer = () => {
  return (
    <footer className='bg-primary_100 py-8 px-4  md:p-14 flex flex-col md:flex-row justify-between gap-8 text-primary'>
      ...
      <div className='w-full flex justify-between gap-6'>
        <div className='flex flex-col justify-between'>
          <div className='flex flex-col gap-2 '>
            ...
            <Link to={"mailto:support@myassignmentnest.com"} className='hover:opacity-50 duration-150 ease-in  '>
              Email: support@myassignmentnest.com
            </Link>
            <Link to={'tel:+918439223922'} className='hover:opacity-50 duration-150 ease-in '>
              Phone: +918439223922
            </Link>
          </div>
        </div>
