...
const PrivacyPolicy = () => {
    return (
        <CommonLayout>
            <section className='max-w-6xl px-4 sm:px-10 mx-auto py-10 '>

                <h1 className='text-2xl xs:text-3xl sm:text-4xl lg:text-5xl text-center font-bold'>
                    Privacy Policy
                </h1>
                <div className='sm:text-lg space-y-2 policy-List policy-heading'>
                    <p>The privacy policy for MyAssignmentnest.com explains why and how we collect, use, store and/or share the details that you provide when using our services, like visiting our website myassignmentnest.com (the website) and approaching us in various relevant ways like marketing, sales or other events.
                    </p>
                    <p>
                        The privacy policy for MyAssignmentnest.com explains why and how we collect, use, store and/or share the details that you provide when using our services, like visiting our website myassignmentnest.com (the website) and approaching us in various relevant ways like marketing, sales or other events.
                    </p>
                    ...
                    <ul className='list-disc px-6 pt-4  flex flex-col gap-2'>
                        ...
                        <li> Usernames of registered users
                        </li>
                        <li>User’s email
                        ...
                        <li>Education, profession and expertise-related details
                        </li>
                        <li>Additional files uploaded by you to our website</li>
                    </ul>
                    <p>
                    ...
                    <p>Our website processes your information for multiple reasons, which again depends on how you use our services. Some of the cases include the following:</p>
                    <ul>
                        <li>We process your information to create, authenticate, and manage your user account. That way, you can sign up to create an account, log in whenever required, and keep it running.</li>
                        <li>Information is used to facilitate and deliver services the user requests. We may process your details to offer the requested services and for order management.</li>
                        <li>We may process your information request feedback and communicate with you about our services and the use of our products.</li>
                        <li>We may process your details to respond to the raised queries and solve potential issues you might encounter while availing of the requested services.</li>
                        <li>We may process your information for sharing administrative details about our official services, products, changes and upgrades in terms and policies, and other important information.</li>
                        <li>We may process your information as part of our initiative to secure our services with fraud monitoring and prevention.</li>
                        <li>We may process your information to evaluate the effectiveness of our marketing campaigns and design the best campaigns relevant to your needs.</li>
                        <li>We may process your information to protect your best interest and secure you from potential harm.</li>
                        <li>We may process your information for archival purposes during a legal case in order to prove events, like in the establishment, pursuit, or defence of claims, relevant to our legitimate interest.</li>
                        <li>We may use your information to respond to you when you reach out to us through email, contact forms, or chatbots.</li>
                        <li>We may de-identify, aggregate, and/or anonymise information collected through our services and website to ensure no information is no longer linked to your identifiable information, like your name and email address. Kindly note we may use anonymised and aggregated information for purposes like research and marketing and may share such information with third parties at our discretion.</li>
                        <li>We constantly work to improve our website, increase your interest in our products and services, and the analytics. We may analyse and monitor the information you provide us during registration, cookies and usage data for details like the date and duration of your last visit, the type of device used, your location, and other relevant information related to the website use and the web traffic.</li>
                        <li>We may use your information for analytics to understand customer engagement and determine the needed features to enhance customer experience and develop useful features to streamline our services.</li>
                        <li>We may also use external compliant services to carry out different polls and surveys, to which you are not obliged to respond. Moreover, we may process your shared data and cookies to optimise and provide relevant advertisements based on your previous searches. However, you are not obliged to respond to them and can opt out anytime.</li>
                        <li>We may process user data, including communications, to respond to any form of dispute or complaint against the website.</li>
                        <li>We may process payment information that complies with the applicable legal requirements of accounting and finance. We may also process information from the platform related to legal concerns raised by you or another person and body for the sake of defence and/or establishing our legal rights.</li>
                    </ul>
                    <h1>
                        With whom do we share your personal information
                    </h1>
                    <p>Our website does not share, sell, or transfer users' personal information to any outside party. However, that excludes the third parties we use to run our website and provide you with our online services and products. That said, be sure that such collaborations only occur if all parties agree not to share, sell, or transfer customer information they receive from our end. Here are some parties we may share your information:</p>
                    <ul>
                        <li>
                            Subcontractors:
                        </li>
                        <p>We work with subcontractors, such as hosting service providers, technicians, IT specialists, website service providers, claim adjusters, advertising and marketing specialists, accounting and bookkeeping offices, and legal advisors, to process personal information, manage technical infrastructure, and ensure proper functionalities of the website. Be sure that all subcontractors work and process information in accordance with the instructions listed in our contract.</p>
                        <li>Advertisers & Intermediaries:</li>
                        <p>
                        ...
                        <li>To respond to claims that suggest us violating the rights of a third party</li>
                        <li>To enforce our privacy policy or any other contract that includes investigating potential violations</li>
                        <li>To comply with the legalities</li>
                        <li>
                    ...
                    <ul>
                        <li>Processing is done with your consent. We will process your data for a purpose only after receiving permission from your end. You can also withdraw your consent anytime by contacting us at <Link className='text-purple-700' to={'mailto:support@myassignmentnest.com'}>support@myassignmentnest.com</Link></li>
                        <li>Processing is done to extend our Services as mentioned in our Terms and Conditions. We will process your data to make sure we fulfil our contractual obligations by providing you with the services you have paid for.</li>
                        <li>Processing is necessary for achieving legitimate interests, but do not overweigh your fundamental rights and interests. Some of the legitimate interests are:</li>
                        <li>Website promotion through social media, media outlets, and affiliates, like influencers and bloggers</li>
                        <li>Compliance with accounting and financial legislation</li>
                        <li>Assessing the company’s business efficiency through the analysis of website traffic and financial performance indicators</li>
                        <li>Experts’ verification and fraud prevention to ensure personal data protection and improve user experience</li>
                        <li>Compliance with legal obligations where necessary in order to cooperate with the regulatory agency and law enforcement body, defend and exercise legal rights, or disclose information as litigation where we are associated</li>
                    </ul>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>Right to access (GDPR Article 15): You have the right to view and ask for your data copies.</li>
                        <li>Right to rectification (GDPR Article 16): You have the right to request to update or correct existing information</li>
                        <li>Right to be forgotten/Right to erasure (GDPR Article 17): You have the right to request data erasure. However, be aware that this is not an absolute right and may vary by law.</li>
                        <li>Right to data portability (GDPR Article 20): You have the right to ask for data transfer to another controller. The data should be provided in an electronic format</li>
                        <li>Right to restrict processing (Article 18): You have the right to request the suppression/restriction of your data.</li>
                        <li>Right to withdraw consent (GDPR Article 7): You have the right to withdraw previously given consent to date processing.</li>
                        <li>Right to object (GDPR Article 21): You have the right to object to data processing.</li>
                        <li>Right to object to automated processing (GDPR Article 22): You have the right to object to automated decision-making or profiling.</li>
                    ...
                    <ul>
                        <li>If the collection is for an individual's interest and we cannot obtain consent on time.</li>
                        <li>If the collection is necessary for assessing, processing, and settling an insurance claim for a witness statement</li>
                        <li>If it is reasonable to expect collection and use with consent would compromise data availability and accuracy, and the collection is reasonable for investigating a breach of an agreement or an infringement of the Canadian province or laws</li>
                        <li>If an individual produced it during the course of their profession or business, and the collection is consistent with the purpose of data production.</li>
                        <li>If the collection is for sole purposes like art, journalism and literature</li>
                    </ul>
                    <p>
                    ...
                    <ul>
                        <li>Anyone who is in California for the temporary or transitory purpose</li>
                        <li>Any individual domiciled in California outside the state for a transitory or temporary purpose. If either of the definitions applies to you, ensure you abide by certain legal rights and obligations related to personal data.</li>
                    </ul>
                    <h1>
                        Rights under the CCPA
                    </h1>
                    <p>The CCPA provides California residents with specific rights for the protection of personal data, like the following:</p>
                    <ul>
                        <li>
                        ...
                        <li>Right to request: You have the right to ask us to disclose information to you regarding data collection, use, sale, sharing, and disclosure of information for business purposes.</li>
                        <li>Right to say no or opt out: You have the right to say no to the sale of personal information. NOTE: WE DO NOT SELL YOUR DATA TO THIRD PARTIES.</li>
                        <li>Right to say no or opt out: You have the right to say no to the sale of personal information. NOTE: WE DO NOT SELL YOUR DATA TO THIRD PARTIES.</li>
                    </ul>
                    <p>
                    ...
                    <ul>
                        <li>To complete the transaction, provide the requested services, take anticipatory actions for your ongoing professional relationship, or otherwise perform our contract with you.</li>
                        <li>To help ensure security and integrity, use your personal information reasonably and proportionately for the necessary purposes.</li>
                        <li>To debug products in order to identify and repair unintended errors in the existing functionality</li>
                        <li>To exercise free speech to ensure another consumer’s rights in exercising their free speech right or other legal rights</li>
                    </ul>
                    <h1>California Electronic Communications Privacy Act (Cal. Penal Code § 1546 et. seq.)</h1>
                    <ul>
                        <li>Engaging in public or peer-reviewed scientific, statistical, or historical research for public benefit while adhering to the applicable ethics and privacy laws when deleting data may seriously impair the achievement of research that you had previously given consent.</li>
                        <li>Enabling solely internal uses aligned with your expectations based on your relationship with our team.</li>
                        <li>Complying with a legal obligation ensures no one is discriminated against. You have the right to exercise your consumer rights without any discrimination. Moreover, you can exercise your rights in the following situations:</li>
                        <li>Denying your services or products</li>
                        <li>Providing unacceptable or different quality products or services</li>
                        <li>Charging different rates, use of discounts, or imposing penalties</li>
                        <li>Suggesting you will receive the products or services at a different level of services</li>
                        <li>Correcting inaccurate personal data on request. Once you confirm the request, we will correct your details in our records.</li>
                        <li>Limiting the use and disclosure of sensitive information. That said, be aware that we don't use or disclose any sensitive information to other parties.</li>
                    </ul>
                    <h1>Exercising the CCPA Data Protection Rights</h1>
                    <p>
                    ...
                    <ul>
                        <li>Disclose sensitive information</li>
                        <li>Be obscure or offensive</li>
                        <li>Be grossly indecent</li>
                        <li>Be used for harassment</li>
                        <li>Make false allegations</li>
                        <li>Break someone’s confidence</li>
                        <li>Encourage someone to send harmful messages deliberately</li>
                        <li>Encourage someone to harm someone</li>
                        <li>
                    ...
                    <ul>
                        <li>Telemarketing</li>
                        <li>Internet pop-ups</li>
                        <li>Warranty information</li>
                        <li>Response to a quote</li>
                        <li>Confirmation of a previously agreed arrangement</li>
                        <li>Employment-related or benefit information</li>
                        <li>Services or products related to the previous purchase</li>
                        <li>Factual information about an ongoing membership</li>
                    </ul>
                    <p>
                    ...
                    <ul><li>Promote personal information protection processed by different bodies</li>
                        <li>Introduce specific conditions for establishing minimum requirements for personal data processing</li>
                        <li>Provide  for establishing an Information Regulator for exercising certain powers and performing duties in terms of this Act and the Promotion of Access to Information Act, 2000</li>
                        <li>Provide to issue codes of conduct.</li>
                        <li>Provide for people's rights regarding unsolicited electronic communications and automated decision-making.</li>
                        <li>Regulate the flow of personal information across Republic borders for connected matters.</li>
                    </ul>
                    <h1>
                        Cybercrimes Act No. 19 of 2020 ('Cybercrimes Act')
                    </h1>
                    <p>Under South African law, cybercrimes are treated as a criminal offence. The Act mandates everyone to clearly understand the regulations before prosecuting them. Cyber extortion, cyber fraud, malicious communication, and unlawful access to the computer system are some of the cybercrimes listed in this Act.</p>
                    <p>
                    ...
                    <p>
                        ...
                        <br />
                        Also, as mentioned earlier, you have the right to withdraw your consent for data processing following the applicable law. With us, you can withdraw your consent at any time by reaching out to us at support@myassignmentnest.com or using the contact details mentioned in the last section of this privacy policy.
                        <br />
                    ...
                    <ul>
                        <li>Essential Cookies: Cookies that are useful for the system's functioning and improve core functionality, authentication, connection stability, security, and more. You can always block cookies on your system, which will likely affect how the websites function.</li>
                        <li>
                    ...
                    <p>
                        Pravya Technologies, a company incorporated under the laws of India with a registered office at 1/2890, Ram Nagar, Shahdara, Delhi, India will be the controller of your personal data.
                    </p>
                    <h1>
                    ...
                    <p>
                        In case of questions or comments about this privacy policy, applicable laws, data safety practices and technologies, or any other queries, feel free to chat with us or email us at
                        <Link to={'mailto:support@myassignmentnest.com.'}>support@myassignmentnest.com.</Link>.
                    </p>
                </div>
            </section>
        </CommonLayout>
